...
mongoose
  ...
  .then(() => {
    ...
    // Function to tokenize text using NLTK in Python
    function tokenizeWithNLTK(text, callback) {
      const pythonProcess = spawn('python', ['nltk_tokenizer.py']);
...
app.post('/api/generate-pdf', (req, res) => {
  ...
  if (format === 'PDF') {
    ...
    tokenizeWithNLTK(education, (tokens) => {
      const formattedText = tokens.join('\n');
      generatePDF(formattedText)
        .then((pdfBytes) => {
